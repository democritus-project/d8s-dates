...
@pytest.mark.xfail(
    reason="pre-existing, unrelated to tooling migration: hardcoded relative-date assertion has gone stale with the current date",
    strict=False,
)
...
@pytest.mark.xfail(reason="pre-existing, unrelated to tooling migration: assumes host timezone is UTC", strict=False)
